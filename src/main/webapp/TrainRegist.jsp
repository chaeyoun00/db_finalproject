...
<%
	...
	String dbUser = "root";
	String dbPass = "1234";
	String query = "SELECT id from train order by id asc";
...
<div class="regist">
	<div class="backsearch">
		<button type="button" onClick="location.href='Train.jsp'"><</button>
	</div>
	<div class="registform">
		<form action="TrainRegistAction.jsp" method="post">
			ID<br>
			<input name="id" type="text" autocomplete="off" value="<%=id%>" readonly><br>
			Type<br>
			<input name="type" type="text" autocomplete="off"><br>
			Status<br>
			<select name="status">
