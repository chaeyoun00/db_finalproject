...
<%
	...
	String dbUser = "root";
	String dbPass = "1234";
	String query = "SELECT id from station order by id asc";
...
<div class="regist">
	<div class="backsearch">
		<button type="button" onClick="location.href='Station.jsp'"><</button>
	</div>
	<div class="registform">
		<form action="StationRegistAction.jsp" method="post">
			ID<br>
			<input name="id" type="text" autocomplete="off" value="<%=id %>"><br>
			Name<br>
			<input name="name" type="text" autocomplete="off"><br>
			Address<br>
			<input name="address" type="text" autocomplete="off"><br>
			Manager Name<br>
			<input name="managerName" type="text" autocomplete="off"><br>
			Telephone<br>
			<input name="tel" type="text" oninput="oninputPhone(this)"><br>
			Budget<br>
